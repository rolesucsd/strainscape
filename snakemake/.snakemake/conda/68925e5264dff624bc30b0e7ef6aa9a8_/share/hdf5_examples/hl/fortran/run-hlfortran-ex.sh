...
prefix="${prefix:-/ddn_scratch/roles/strain_analysis/iHMP/strainscape/snakemake/.snakemake/conda/68925e5264dff624bc30b0e7ef6aa9a8_}"
PARALLEL=no             # Am I in parallel mode?
AR="/home/conda/feedstock_root/build_artifacts/hdf5_1737515482579/_build_env/bin/x86_64-conda-linux-gnu-ar"
RANLIB="/home/conda/feedstock_root/build_artifacts/hdf5_1737515482579/_build_env/bin/x86_64-conda-linux-gnu-ranlib"
if [ "$PARALLEL" = no ]; then
